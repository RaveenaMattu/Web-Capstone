...
$instructorImageFile = (!empty($instructor['imageName'])) ? $instructor['imageName'] : 'placeholder.jpg';
  ...
  <main id="addInstructorMain">
    ...
    <form action="update_instructor.php" method="post" enctype="multipart/form-data" id="addUpdateForm">
      ...
      <div class="form-group">
        ...
        <p>Current Image:</p>
        <img src="<?php echo htmlspecialchars('../images/' . $instructorImageFile); ?>" width="80" height="80" alt="Instructor Image">
      </div>
