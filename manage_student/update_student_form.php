<?php
  ...
  $studentImageFile = (!empty($student['imageName'])) ? $student['imageName'] : 'placeholder.jpg';
  ...
  <main id="addInstructorMain">
    ...
    <form action="update_student.php" method="post" enctype="multipart/form-data" id="addUpdateForm">
      ...
      <div class="form-group">
        ...
        <p>Current Image:</p>
        <img src="<?php echo htmlspecialchars('../images/' . $studentImageFile); ?>" width="80" height="80" alt="Student Image">
      </div>
